        ...
        <div class="card-body">
          ${outcome === 'sync_json_errors'
            ...
            : outcome === 'push_failed'
              ? html`
                  <p>
                    Your change was committed locally but could not be pushed to the remote GitHub
                    repository. This is usually caused by a temporary GitHub outage or a network
                    problem.
                  </p>
                  <p>
                    To keep the local copy and GitHub consistent, your change was
                    <strong>not saved</strong> and the local copy was reset to the version currently
                    on GitHub. No changes were lost on GitHub. Please try your edit again once
                    GitHub is reachable.
                  </p>
                `
              : html`
